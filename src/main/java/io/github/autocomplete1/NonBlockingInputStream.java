...
public class NonBlockingInputStream extends InputStream implements Runnable {
	private static final Logger logger = Logger.getLogger(NonBlockingInputStream.class.getName());
	...
	//@Override
	public void run () {
		logger.log(Level.FINE, "NonBlockingInputStream start");
		...
		logger.log(Level.FINE, "NonBlockingInputStream shutdown");
	}
}
